...
namespace Plugin.TypeDescriptorCycleA;

public class LocalTypeA { }

public class LocalProviderA : TypeDescriptionProvider { }

public class TestCase
{
    public void Execute()
    {
        var provider = new LocalProviderA();
        TypeDescriptor.AddProvider(provider, typeof(LocalTypeA));

        TypeDescriptor.GetProperties(typeof(LocalTypeA));
        TypeDescriptor.GetConverter(typeof(LocalTypeA));

        TypeDescriptor.RemoveProvider(provider, typeof(LocalTypeA));
